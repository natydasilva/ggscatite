...
The methods are implemented in `ggscatite` R package that extends `geom_jitter()` on two dimensions, and is accecible on https://github.com/natydasilva/ggscatite 
